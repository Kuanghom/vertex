<template>
  ...
  <div class="u2-rss">
    ...
    <a-form
      ...
      <a-form-item label="种子大小(GiB)" extra="0 表示不限制">
        <a-input-group compact>
          <a-input size="small" v-model:value="form.torrentMinSizeGiB" style="width: 120px;" placeholder="最小"/>
          <a-input size="small" style="width: 30px; pointer-events: none; text-align: center;" placeholder="~" disabled />
          <a-input size="small" v-model:value="form.torrentMaxSizeGiB" style="width: 120px;" placeholder="最大"/>
        </a-input-group>
      </a-form-item>
      ...
      <a-form-item :wrapperCol="isMobile() ? { span: 24 } : { span: 20, offset: 4 }">
        ...
        <a-button style="margin-left: 12px;" :loading="previewLoading" @click="previewFeed">预览</a-button>
        <a-button style="margin-left: 12px;" @click="regenerateToken">重置 RSS Token</a-button>
      </a-form-item>
    </a-form>
    <a-divider></a-divider>
  ...
  methods: {
    ...
    buildPayload () {
      return {
        ...
        torrentMinSize: Math.round((+this.form.torrentMinSizeGiB || 0) * GIB),
        torrentMaxSize: Math.round((+this.form.torrentMaxSizeGiB || 0) * GIB)
      };
    },
    resetSecretState () {
