<template>
  <div class="watch fn-page">
    ...
    <a-table
      ...
      :locale="tableLocale"
      size="small"
      :data-source="filterAdminList(watches, ['alias', 'id'])"
      ...
      <template #bodyCell="{ column, record }">
        ...
        <template v-if="column.title === '操作'">
          <fn-ops>
            ...
            <a-popconfirm title="确认删除这条数据？" ok-text="删除" cancel-text="取消" @confirm="deleteWatch(record)">
      ...
      <a-form
        ...
        <a-form-item
          ...
          <a-table
            class="fn-edit-table"
            :style="`font-size: ${isMobile() ? '12px': '14px'};`"
            :columns="asCardColumns(scrapeColumns)"
            size="small"
            :data-source="watch.forceScrape"
            :pagination="{ pageSize: 20, hideOnSinglePage: true }"
            :scroll="cardScroll(scrapeColumns)"
          >
            <template #bodyCell="{ column, record }">
